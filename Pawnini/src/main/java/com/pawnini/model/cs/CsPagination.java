...
public class CsPagination {
	...
	public static final int BLOCK_SCALE = 8;		//화면당 페이지수 
	
	private int curPage;	//현재 페이지
	private int prevPage;	//이전 페이지
	private int nextPage;	//다음 페이지
	private int totPage;	//총 페이지 갯수
	private int totBlock; //총 페이지 블록 갯수 (if totPage = 82 and pagescale = 8 then totBlock would be = 11
	...
	public void setBlockRange() {
		...
		//[prevPage],[nexPage] 을 눌렀을때 이동할 페이지 번호
	...
	public String toString() {
		return "CsPager [curPage=" + curPage + ", prevPage=" + prevPage + ", nextPage=" + nextPage + ", totPage="
